									...
									disputes.map((data, index) => {
										...
										return (
											<tbody className="w-full" key={index + 1}>
												<tr className="flex rounded-md pt-2 pb-2  justify-between border-b px-1 items-end ">
													<td className="w-[15%]">{index + 1}</td>
													<td className="text-left">{complaint}</td>
													<td className="text-center w-1/5">
														{reason === 0 && 'Unresolved'}
														{/* <td className='text-center w-1/5' >{reason === 0 && 'Unresolved' } */}
														{reason === 1 && 'Delayed'}
