...
function Signup() {
	...
	const path =
		userType === 'business'
			? '/auth/create_account'
			: '/lawyer/auth/create_account';
	useEffect(() => {
		userType === 'business'
			? businessNameValid
				? setNameValid(true)
				: setNameValid(false)
			: lawyerName !== '' && lawyerSurname !== ''
			? setNameValid(true)
			: setNameValid(false);
	...
	useEffect(() => {
		...
		lawyerSurname !== ''
			? setLawyerSurnameValid(true)
			: setLawyerSurnameValid(false);
		EMAIL_REGEX.test(email) ? setEmailValid(true) : setEmailValid(false);
		PASSWORD_REGEX.test(password)
			? setPasswordValid(true)
			: setPasswordValid(false);
		confirmPassword === password && PASSWORD_REGEX.test(confirmPassword)
						...
						<>
							<div className="business-name">
								...
								<input
									...
									required
								/>
								{!lawyerNameFocus && !lawyerNameValid && triedToSubmit && (
							...
							<div className="business-name">
								...
								<input
									type="text"
									className={
										triedToSubmit && !lawyerSurnameValid ? 'invalid' : ''
									}
									id="business-name"
									value={lawyerSurname}
									name="first_name"
