...
You release us from any liability incurred by us in connection with
    ...
    <ul> 
    <P>- You must provide the company access to relevant personnel of the client and all
...
the purpose of company’s performance of its obligations under this agreement.
    ...
    <P>- Our reliance upon any image or data or documentation provided by you.
</P>
    <P>- Our compliance with any instructions by you in relation to provision of services.
</P>
    <P>- Any damage to the reputation of the company suffered as a consequence of a
breach of agreement, except that the company has contributed to the loss.</P>
...
. </P>
    <ul> 
    <P>-  If the company is required to provide services in circumstances order than those
anticipated in this agreement.
</P>
    <P>- If there is any change in the timing of the services.
The date for the provision of services will be delayed.
</P>
    <P>- The company may need to increase the fees relating to the provision of any
amended services which occurs as a result of any event provided that the clients
consent to the increase in fees</P>
    </ul>
...
rendered.
    ...
    <P>- Unless there is an agreement in writing, payment or fees must be made by credit
...
details from the first payment and use this to charge subsequent payment.</P>
    </ul>
