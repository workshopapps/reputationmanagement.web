	...
	return (
		<PageLayout>
			<section className="p-8">
				<div className="flex flex-col m-auto lg:w-[50%]">
					<Link
					...
					<section className="my-5">
						<h1 className="text-3xl mt-3 font-bold">CRIMINAL DEFENSE LAWYER</h1>
						...
						<div className="py-8 -mt-7">
							...
							<h4 className="max-w-2xl text-justify">
								We are looking for people who are passionate about the
								relentless pursuit of perfection; people who are never
								satisfied, who want to change the world and make it into their
								own image, who want to leave a mark; people who want to join an
								exceptional and extraordinary team of individuals creating great
								products and having an impact on millions of lives across Africa
								and the world at large; people who are either exceptionally
								gifted at what they do or want to grow to become exceptionally
