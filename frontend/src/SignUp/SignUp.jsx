...
import Closed from'../SignUp/Assets/eye-slash.png';
import background from '../SignUp/Assets/background.png';
import Logo from '../SignUp/Assets/Logo(1).png'
function Signup() {
  const InitialValues = {
    first_name: "",
    last_name: "",
  ...
  return (
    <div className="SignUp place-content-center flex flex-row ">
        <div className="left-s place-content-start text-left gap-x-7">
            <h2 className='font-bold text-6xl place-content-start w-3/4 ml-5 mt-6 '>Welcome to Fixit</h2>
          ...
          />       
           ...
           <span cla></span>
               <input className='border-solid border-2 border-black mt-2 w-80 h-9' type={passwordShown ? "text" : "password"} />
                <button onClick={togglePassword}><img src={Closed} alt='' /> </button>
